...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set g_led [ create_bd_port -dir O g_led ]
  set r_led [ create_bd_port -dir O r_led ]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins vhdlnoclk_0/clk]
  connect_bd_net -net vhdlnoclk_0_g_led [get_bd_ports g_led] [get_bd_pins vhdlnoclk_0/g_led]
  connect_bd_net -net vhdlnoclk_0_r_led [get_bd_ports r_led] [get_bd_pins vhdlnoclk_0/r_led]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins vhdlnoclk_0/eoss] [get_bd_pins xlconstant_0/dout]
