...
HD_PWD='C:/Users/20002890/minized_vhdl_no_clk/minized_vhdl_no_clk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vhdlnoclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vhdlnoclk.tcl
