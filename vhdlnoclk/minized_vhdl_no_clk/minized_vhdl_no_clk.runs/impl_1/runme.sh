...
HD_PWD='C:/Users/20002890/minized_vhdl_no_clk/minized_vhdl_no_clk.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vhdlnoclk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vhdlnoclk.tcl -notrace
