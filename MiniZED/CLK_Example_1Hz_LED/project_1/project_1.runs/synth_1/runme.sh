...
HD_PWD='D:/GIT/Github/DigitaleSystemenVHDL/CLK_Example_1Hz_LED/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_example_1Hz_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_example_1Hz_led.tcl
