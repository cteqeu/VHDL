...
HD_PWD='C:/Users/20002890/11_VHDL_1819/11_VHDL_1819.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hardware.tcl
