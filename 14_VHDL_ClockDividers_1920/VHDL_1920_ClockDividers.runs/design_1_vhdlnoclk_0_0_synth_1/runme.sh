...
HD_PWD='C:/devWorks/FPGA/VHDL_1920_ClockDividers/VHDL_1920_ClockDividers.runs/design_1_vhdlnoclk_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vhdlnoclk_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vhdlnoclk_0_0.tcl
