...
HD_PWD='C:/Users/20002890/DS_CLK_LEDS/DS_CLK_LEDS.runs/design_1_DS_CLK_LEDS_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_DS_CLK_LEDS_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_DS_CLK_LEDS_0_0.tcl
