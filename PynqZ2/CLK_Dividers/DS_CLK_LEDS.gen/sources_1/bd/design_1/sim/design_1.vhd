...
architecture STRUCTURE of design_1 is
  component design_1_DS_CLK_LEDS_0_0 is
  port (
    clk : in STD_LOGIC;
    leds : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component design_1_DS_CLK_LEDS_0_0;
  ...
  signal DS_CLK_LEDS_0_leds : STD_LOGIC_VECTOR ( 3 downto 0 );
...
begin
  ...
  leds_0(3 downto 0) <= DS_CLK_LEDS_0_leds(3 downto 0);
DS_CLK_LEDS_0: component design_1_DS_CLK_LEDS_0_0
     port map (
      clk => clk_wiz_0_clk_out1,
      leds(3 downto 0) => DS_CLK_LEDS_0_leds(3 downto 0)
    );
