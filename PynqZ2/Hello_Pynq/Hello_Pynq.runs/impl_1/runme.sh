...
HD_PWD='C:/devWorks/Hello_Pynq/Hello_Pynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log boolean_and.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source boolean_and.tcl -notrace
