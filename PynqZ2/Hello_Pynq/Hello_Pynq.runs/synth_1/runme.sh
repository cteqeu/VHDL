...
HD_PWD='C:/devWorks/Hello_Pynq/Hello_Pynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boolean_and.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source boolean_and.tcl
