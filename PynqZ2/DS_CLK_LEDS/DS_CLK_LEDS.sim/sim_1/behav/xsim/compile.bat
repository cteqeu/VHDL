...
REM
REM Generated by Vivado on Tue Mar 01 10:57:46 +0100 2022
...
echo "xvhdl --incr --relax -prj DS_CLK_LEDS_vhdl.prj"
call xvhdl  --incr --relax -prj DS_CLK_LEDS_vhdl.prj -log xvhdl.log
